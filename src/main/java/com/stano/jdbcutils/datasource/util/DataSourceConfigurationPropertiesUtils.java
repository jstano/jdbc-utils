...
public class DataSourceConfigurationPropertiesUtils {
  public static Optional<DataSourceConfigurationProperties> getDataSourceConfigurationProperties(DataSource dataSource) {
    if (dataSource instanceof TracingBasicDataSource) {
      ...
      return createDataSourceConfigurationProperties(tracingBasicDataSource.getUrl(),
    ...
    if (dataSource instanceof BasicDataSource) {
      ...
      return createDataSourceConfigurationProperties(basicDataSource.getUrl(),
  ...
  private static Optional<DataSourceConfigurationProperties> createDataSourceConfigurationProperties(String url,
                                                                                                     String username,
                                                                                                     String password) {
    if (url != null) {
