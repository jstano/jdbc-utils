...
public final class DataSourceUtil {
  ...
  public static String getUrlFromDataSource(DataSource dataSource) {
    Optional<DataSourceConfigurationProperties> dataSourceConfigurationProperties = DataSourceConfigurationPropertiesUtils.getDataSourceConfigurationProperties(
      dataSource);
