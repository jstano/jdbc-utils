...
public final class DataSourceFactory {
  private static final Map<DataSourceProperties, DataSource> dataSourceMap = new ConcurrentHashMap<>();
  ...
  public static DataSource getDataSource(String databaseUrl, String userName, String password, DriverType driverType) {
